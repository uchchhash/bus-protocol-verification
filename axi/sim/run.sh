...
declare -a array1
declare -a array2
array2=(apb_spi_base_test apb_spi_test_package spi_reg_wr_test spi_reg_reset_test spi_cov_test)
...
then
    ...
    irun -timescale 1ns/1ps -f filelist.f -access +rwc -uvm -svseed random +UVM_VERBOSITY=$2 +UVM_TESTNAME=$3 -coverage all -covtest $3 -covfile toggle_exclude.ccf
	iccr iccr_cov.cmd
	firefox html*/index.html &
